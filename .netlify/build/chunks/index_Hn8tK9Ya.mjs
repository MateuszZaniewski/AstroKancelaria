/* empty css                         */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, g as addAttribute, a as renderComponent, f as createAstro, i as renderSlot, h as renderHead } from './astro/server_Dkz4iR9-.mjs';
import 'kleur/colors';
import { a as $$CtaButton, $ as $$Header } from './Header_fteIv24r.mjs';
import 'clsx';
import { $ as $$ViewTransitions } from './ViewTransitions_CyA-yWbD.mjs';
import { jsx } from 'react/jsx-runtime';
import { atom } from 'nanostores';
/* empty css                        */

const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="hero"${addAttribute(`bg-[url('/t\u0142oMobile.svg')] md:bg-[url('/t\u0142oLg.svg')] lg:bg-[url('/t\u0142oLg.svg')] xl:bg-[url('/t\u0142o2xl.svg')] min-h-[100vh] min-h-screen w-auto bg-cover bg-center md:bg-right-top lg:bg-right-top xl:bg-top xl:max-w-[2600px] xl:mx-auto`, "class")}> <div class="flex flex-col items-center justify-between min-h-screen xl:mr-[16vw]"> <div class="w-full px-12 md:px-0 lg:px-12 pt-[13.062vh] md:pl-[2vw] lg:w-[1100px] lg:mr-0 2xl:max-w-[2000px] 2xl:pt-44 2xl:pr-[25vw] h-full"> <div class="flex justify-center pb-[4.7vh] max-w-[400px] mx-auto lg:mx-0 lg:max-w-[770px] md:mx-0"> <img src="adwokatura.svg" class="lg:w-32 lg:h-32 md:w-24 md:h-24 w-[36.923vw] h-[17.062vh] max-w-[144px] md:max-w-full" alt="logo-adwokatura"> </div> <div class="flex flex-col gap-[4.7vh] text-center pb-[6.4vh] max-w-[400px] md:max-w-[400px] mx-auto lg:justify-start lg:mx-0 lg:max-w-[770px] md:mx-0"> <h1 class="font-cinzel leading-[1.2] 2xl:text-6xl lg:text-5xl md:text-[40px] text-[30px]" aria-label="Kancelaria adwokacka">
...
</h1> </div> <div class="flex flex-col items-center gap-[3.5vh] justify-center md:max-w-[400px] lg:max-w-[770px] lg:flex-row lg:gap-12"> <a href="#contact" class="nav-link" aria-label="link to contact"> ${renderComponent($$result, "CtaButton", $$CtaButton, { "text": "SKONTAKTUJ SI\u0118", "variant": "contain" })} </a> <a href="#services" class="nav-link" aria-label="link to services"> ${renderComponent($$result, "CtaButton", $$CtaButton, { "text": "US\u0141UGI PRAWNE", "variant": "outlined" })} </a> </div> </div> <div class="flex items-end h-full sm:h-24 mt-8 md:h-16 w-4 md:hidden"> <div class="bg-[#B58C67] w-[2px] h-16 relative overflow-hidden"> <div class="bg-[#0E1F2A] w-[2px] rounded-full h-4 absolute -top-4 left-0 animate-animateLine"></div> </div> </div> </div> </div>`;
}, "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/features/hero/hero.astro", void 0);

const $$Astro$3 = createAstro("https://www.adwokatkomenda.pl/");
...
const $$About = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="bg-[#0E1F2A] text-[#B58C67] pt-10 lg:pt-20 pb-10 lg:pb-32 md:px-[9.3vw]" id="about"> ${renderComponent($$result, "Heading", $$Heading, { "text": "O MNIE" })} <div class="flex flex-col-reverse lg:flex-row lg:gap-12 gap-7 sm:gap-10 2xl:max-w-[1600px] 2xl:mx-auto"> <div class="max-w-[596px] sm:max-w-[760px] sm:mx-auto sm:px-[10vw] px-[5vw] lg:px-0 lg:pt-14"> <h3 class="text-normal sm:text-lg pb-5 lg:pb-10">
...
W 2018 roku ukończyłam studia na Wydziale Prawa Uniwersytetu w
          Białymstoku. W latach 2019 - 2021 odbyłam aplikację adwokacką w
          Białostockiej Izbie Adwokackiej. <br> W 2022 roku zdałam egzamin zawodowy
          i zostałam wpisana na listę adwokatów Izby Adwokackiej w Białymstoku.
</p> <p>
...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="bg-[#EEE5DA] pb-10 lg:min-h-[100vh] 2xl:min-h-fit" id="services"> ${renderComponent($$result, "ServicesReact", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/features/services/ServicesReact", "client:component-export": "ServicesReact" })} </section>`;
}, "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/features/services/Services.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="bg-[#0E1F2A] pt-5 md:pt-14 lg:pt-20 pb-5 text-[#B58C67]" id="footer"> <div class="px-[5vw] lg:px-0 lg:pl-[9.3vw] pb-16"> <h2 class="text-4xl font-cinzel">PAULINA KOMENDA</h2> <h2 class="text-2xl font-cinzel">KANCELARIA ADWOKACKA</h2> </div> <div class="flex flex-col sm:flex-row sm:flex-wrap sm:justify-start sm:gap-x-12 sm:gap-y-5 md:justify-start md:pr-2 lg:justify-center"> <div${addAttribute(`${containerStyle} md:order-2`, "class")}> <h3${addAttribute(`${headingStyle}`, "class")}>USŁUGI PRAWNE</h3> <div class="hidden lg:block"> <div${addAttribute(`${elementsStyle}`, "class")}> ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 0, "linkTo": "#tgt", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo rodzinne` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 1, "linkTo": "#tgt", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Konwencja Haska` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 2, "linkTo": "#tgt", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo spadkowe` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 3, "linkTo": "#tgt", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo karne` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 4, "linkTo": "#tgt", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo cywilne` })} </div> </div> <div class="block lg:hidden"> <div${addAttribute(`${elementsStyle}`, "class")}> ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 0, "linkTo": "#rodzinne", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo rodzinne` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 1, "linkTo": "#haska", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Konwencja Haska` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 2, "linkTo": "#spadkowe", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo spadkowe` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 3, "linkTo": "#karne", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo karne` })} ${renderComponent($$result, "FooterLink", FooterLink, { "client:load": true, "tabNum": 4, "linkTo": "#cywilne", "client:component-hydration": "load", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/components/FooterLink", "client:component-export": "FooterLink" }, { "default": ($$result2) => renderTemplate`Prawo cywilne` })} </div> </div> </div> <!--  --> <div${addAttribute(`${containerStyle} pt-12 sm:pt-0 md:order-3`, "class")}> <h3${addAttribute(`${headingStyle}`, "class")}>KANCELARIA</h3> <div${addAttribute(`${elementsStyle}`, "class")}> <a aria-label="link to about section" href="#about"${addAttribute(`${linkStyles} h-fit`, "class")}>O mnie</a> <a aria-label="link to blog section" href="#blog"${addAttribute(`${linkStyles}`, "class")}>Blog</a> <a aria-label="link to facebook" href="#"${addAttribute(`${linkStyles}`, "class")}>Facebook</a> <a aria-label="link to instagram" href="#"${addAttribute(`${linkStyles}`, "class")}>Instagram</a> <a aria-label="link to rodo" href="/rodo" target="_blank" class="hover:font-semibold cursor-pointer text-normal active:text-[#D9C6AF] focus:border-[#533630]">RODO</a> </div> </div> <!--  --> <div${addAttribute(`${containerStyle} pt-12 sm:pt-0 md:order-1`, "class")}> <a aria-label="link to contact" href="#contact"${addAttribute(`${headingStyle} nav-link`, "class")}>KONTAKT</a> <div class="flex flex-col gap-5 text-normal"> <span>ul. Sienkiewicza 55A/90 15-002 Białystok <br> Spółdzielnia "Trzy Kłosy"</span> <span>Pon - Pt 9:00 - 17:00</span> <a aria-label="link to phone" href="tel:+48508726150" class="hover:font-semibold footer-phone">Tel.: 508 726 150</a> <a aria-label="link to email" href="mailto:adw.komenda@gmail.com" class="hover:font-semibold md:min-w-52 footer-email">adw.komenda@gmail.com</a> <span>NIP: 9662171426 </span> </div> </div> </div> <div class="flex gap-2 lg:gap-10 items-center justify-center pt-14 pb-10 px-[5vw] lg:px-10"> <div class="grow w-auto h-[1px] bg-[#B58C67]"></div> <img loading="lazy" class="max-w-[300px] max-h-[83px]" src="/newLogoForDarkBackground.svg" alt="logoKancelariaPaulinaKomenda"> <div class="grow w-auto h-[1px] bg-[#B58C67]"></div> </div> </section>`;
...
var _a;
const $$Astro$2 = createAstro("https://www.adwokatkomenda.pl/");
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Layout;
  const { title } = Astro2.props;
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><script type="application/ld+json">\n      {\n        "@context": "https://schema.org",\n        "@type": "LegalService",\n        "name": "Kancelaria Adwokacka Paulina Komenda Bia\u0142ystok",\n        "description": "Kancelaria Adwokacka Paulina Komenda Bia\u0142ystok - kompleksowa obs\u0142uga klient\xF3w w zakresie prawa rodzinnego, karnego, cywilnego oraz spadkowego.",\n        "url": "https://www.adwokatkomenda.pl/",\n        "contactPoint": {\n          "@type": "ContactPoint",\n          "telephone": "+48508726150",\n          "contactType": "Customer Service",\n          "areaServed": "PL",\n          "availableLanguage": ["Polish", "English"]\n        }\n      }\n    <\/script><script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="6f12c5da-6d0e-426a-9d66-ecb71c5a273d" type="text/javascript"><\/script><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="sitemap" href="/sitemap-index.xml"><link rel="canonical" href="https://www.adwokatkomenda.pl/"><meta name="generator"', "><title>", "</title>", "<!-- Google Tag Manager --><!-- End Google Tag Manager -->", '</head> <body> <section class="relative"> ', " ", " ", ' </section> <!-- Google Tag Manager (noscript) --> <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MJV6G6WP" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> <!-- End Google Tag Manager (noscript) --> </body></html>'])), addAttribute(Astro2.generator, "content"), title, renderComponent($$result, "ViewTransitions", $$ViewTransitions, {}), renderHead(), renderComponent($$result, "Header", $$Header, { "animate": false }), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}));
...
const $$Background = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="min-h-[80vh] w-full" id="background"> <div class="fixed left-0 top-0 -z-10 min-h-full w-full bg-[url('/statuaMobile.svg')] bg-cover bg-center bg-no-repeat opacity-100 sm:bg-[url('/statuaFull.svg')] sm:bg-right-top 2xl:mx-auto"></div> </div>`;
...
const $$Reviews = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="bg-[#EEE5DA] pt-10 lg:pt-20" id="opinions"> ${renderComponent($$result, "ReviewsReact", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/features/reviews/ReviewsReact", "client:component-export": "ReviewsReact" })} </section>`;
}, "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/features/reviews/Reviews.astro", void 0);

const $$Blog = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="bg-[#EEE5DA] pb-10 lg:pb-24 pt-10 lg:pt-20" id="blog"> ${renderComponent($$result, "BlogReact", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/features/blog/BlogReact", "client:component-export": "BlogReact" })} </section>`;
}, "C:/Users/mateu/Desktop/Kancelaria-PaulinaKomenda/src/features/blog/Blog.astro", void 0);

const $$Astro$1 = createAstro("https://www.adwokatkomenda.pl/");
...
Zadzwoń i umów się na spotkanie w kancelarii. <br> We offer comprehensive
        legal support in English for the foreign clients.
