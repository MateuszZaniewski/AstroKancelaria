...
</h1> </div> <div class="flex flex-col items-center gap-[3.5vh] justify-center md:max-w-[400px] lg:max-w-[770px] lg:flex-row lg:gap-12"> <a href="#contact" class="nav-link" aria-label="link to contact"> ${renderComponent($$result, "CtaButton", $$CtaButton, { "text": "SKONTAKTUJ SI\u0118", "variant": "contain" })} </a> <a href="#services" class="nav-link" aria-label="link to services"> ${renderComponent($$result, "CtaButton", $$CtaButton, { "text": "US\u0141UGI PRAWNE", "variant": "outlined" })} </a> </div> </div> <!-- Animate to this point --> <div class="flex items-end h-full sm:h-24 mt-8 md:h-16 w-4 md:hidden"> <div class="bg-[#B58C67] w-[2px] h-16 relative overflow-hidden"> <div class="bg-[#0E1F2A] w-[2px] rounded-full h-4 absolute -top-4 left-0 animate-animateLine"></div> </div> </div> </div> </div>`;
